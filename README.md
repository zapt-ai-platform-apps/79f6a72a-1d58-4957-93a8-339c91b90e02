...
5. **اختيار المحطة**:
   - ستظهر قائمة بمحطات الراديو المتاحة.
   - اختر المحطة التي ترغب في الاستماع إليها.
   - سيبدأ البث تلقائيًا.
6. **التحكم في البث**:
   - لإيقاف البث، اضغط على "**إيقاف التشغيل**".
7. **إغلاق الراديو**: اضغط على "**✖️**" للعودة إلى الشاشة الرئيسية.
