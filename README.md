...
6. **الأدوات**
   ...
   - **محرر النصوص**: تصحيح النصوص، إعادة صياغتها، تشكيلها، وترجمتها مع إمكانية اختيار اللغة المستهدفة.
...
### 4. ترجمة النص باستخدام محرر النصوص

1. **فتح التطبيق**: افتح التطبيق من متصفح الويب.
2. **الضغط على تبويب أدوات**: انقر على أيقونة **أدوات** في شريط التنقل السفلي.
3. **اختيار محرر النصوص**: انقر على زر **محرر النصوص**.
4. **إدخال النص**: اكتب النص الذي ترغب في ترجمته في حقل النص المتاح.
5. **اختيار ترجمة النص**: اضغط على زر **ترجمة النص**.
6. **اختيار اللغة**: حدد اللغة التي ترغب في الترجمة إليها من القائمة المنسدلة.
7. **تنفيذ الترجمة**: سيتم معالجة النص وترجمته إلى اللغة المحددة.
8. **مشاهدة النص المترجم**: سيتم عرض النص المترجم على الشاشة.
...
### 8. متابعة حسابات التواصل الاجتماعي
...
- **OpenAI GPT-3**: لتوليد النصوص، الإجابات الذكية، وترجمة النصوص.
- **تحويل النص إلى كلام**: لتحويل النصوص إلى صوت للمستخدمين.
- **Sentry**: لمراقبة الأخطاء وتحسين الأداء.

## ملاحظات إضافية

- **إضافة خاصية ترجمة النص**: تم إضافة ميزة ترجمة النص في محرر النصوص مع إمكانية اختيار اللغة المستهدفة.
