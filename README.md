...
- **إظهار وإخفاء القائمة العلوية:**
  ...
  - **خطوات الاستخدام:**
    ...
    4. ستتمكن من الوصول إلى العناصر التالية في القائمة العلوية:
       ...
       - **لوحة التحكم:** (مرئية فقط للمسؤول) الوصول إلى لوحة تحكم المسؤول لإدارة التطبيق.
...
- **الوصف:**
  - تمكين المسؤول من الوصول إلى لوحة التحكم لإدارة التطبيق والتحكم الكامل في الميزات والخيارات.

- **خطوات الاستخدام:**
  1. **تسجيل الدخول كمسؤول:**
     - استخدم البريد الإلكتروني: `daoudi.abdennour@gmail.com` للدخول كمسؤول.
  2. **الوصول إلى لوحة التحكم:**
     - بعد تسجيل الدخول بحساب المسؤول، سيظهر زر **"لوحة التحكم"** في القائمة العلوية.
     - اضغط على **"لوحة التحكم"** للانتقال إلى صفحة الإدارة.
  3. **الميزات المتاحة في لوحة التحكم:**
     - **إدارة المستخدمين:** عرض قائمة المستخدمين والتحكم في حساباتهم.
     - **عرض الرسائل:** الوصول إلى الرسائل المستلمة من نموذج "تواصل معنا" و"انضم إلينا".
     - **إحصائيات الاستخدام:** عرض وتحليل إحصائيات استخدام التطبيق.
     - **إدارة المحتوى:** تعديل وتحديث محتوى التطبيق والأدوات المتاحة.
