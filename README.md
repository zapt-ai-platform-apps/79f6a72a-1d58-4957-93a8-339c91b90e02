...
4. **منشئ السيرة الذاتية بالذكاء الاصطناعي**: أنشئ سيرة ذاتية احترافية بناءً على معلوماتك الشخصية باستخدام الذكاء الاصطناعي، مع إمكانية **نسخ، استماع، وإعادة إنشاء** السيرة الذاتية.
...
4. **إدخال المعلومات الشخصية**:
   - املأ **الاسم الكامل** و**المسمى الوظيفي**.
   - اكتب **الملخص المهني** (اختياري).
   - أدخل **المهارات** (افصل بين المهارات بفاصلة).
   - اكتب **الخبرات العملية** و**التعليم** (اختياري).
...
*...* (باقي رحلات المستخدم تبقى كما هي في الوصف السابق).
