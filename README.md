...
### إضافة مقال جديد (للمشرفين)

1. من لوحة التحكم الإدارية، اختر "إدارة المقالات".
2. انقر على زر "إضافة مقال جديد".
3. قم بتعبئة النموذج التالي:
   - **عنوان المقال**: أدخل عنوان المقال.
   - **محتوى المقال**: أدخل نص المقال بالكامل.
   - **التصنيف**: اختر التصنيف المناسب للمقال من القائمة المنسدلة.
4. انقر على زر "إضافة المقال" لحفظ المقال الجديد.
5. ستظهر رسالة تأكيد بأن المقال تم إضافته بنجاح.
6. سيتم عرض المقال في قائمة المقالات ويمكن للمستخدمين رؤيته في قسم المدونة.
