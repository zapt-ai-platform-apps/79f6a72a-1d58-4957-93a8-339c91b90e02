...
7. **معالجة النص**: اضغط على زر **معالجة النص**.
...
- **إضافة ترجمة النص في محرر النصوص**: تمت إضافة خيار جديد في محرر النصوص يتيح للمستخدمين ترجمة النصوص إلى لغات متعددة مع إمكانية اختيار اللغة المستهدفة.
