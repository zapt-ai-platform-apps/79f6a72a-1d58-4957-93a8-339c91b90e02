...
5. **استعراض المحطات**:
   - ستظهر قائمة بالمحطات المتاحة لتلك الدولة.
   - استخدم شريط التمرير للوصول إلى المحطات الأخرى.
6. **تشغيل المحطة**:
   - اضغط على زر "**تشغيل**" بجانب المحطة التي ترغب في الاستماع إليها.
   - ستبدأ المحطة في البث المباشر.
7. **إيقاف المحطة**:
