...
1. **الصفحة الرئيسية (الرئيسية)**: تحتوي على معلومات ترحيبية وتوجيهية للمستخدمين.
...
3. **الصفحة الرئيسية**: انقر على تبويب **الرئيسية** في أسفل الشاشة للوصول إلى الصفحة الرئيسية حيث تجد معلومات ترحيبية وتوجيهية.
