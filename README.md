...
5. **البحث عن محطة**:
   - استخدم مربع البحث للبحث عن محطة معينة بالاسم.
6. **اختيار المحطة**:
   - ستظهر قائمة بالمحطات المتاحة، مع عرض الصور أو الشعارات الخاصة بها.
   - اضغط على زر "**تشغيل**" لتشغيل المحطة.
7. **إدارة المفضلة**:
   - لإضافة محطة إلى المفضلة، اضغط على رمز النجمة "**☆**".
   - ستتحول النجمة إلى "**★**" للإشارة إلى أنها الآن في المفضلة.
   - لإزالة محطة من المفضلة، اضغط على النجمة مرة أخرى.
...
9. **العودة إلى الشاشة الرئيسية**: اضغط على زر "**🔙**" الموجود في أعلى الصفحة.
