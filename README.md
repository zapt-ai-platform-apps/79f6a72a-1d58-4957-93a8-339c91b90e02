...
1. **الصفحة الرئيسية**
   ...
   - قسم **"تابعونا على شبكات التواصل الاجتماعي"** لسهولة الوصول إلى منصات التواصل الاجتماعي الخاصة بنا.
...
1. **فتح التطبيق**: افتح التطبيق من متصفح الويب.
2. **الانتقال إلى قسم تابعونا**: قم بالتمرير إلى أسفل الصفحة الرئيسية حتى تصل إلى قسم **تابعونا على شبكات التواصل الاجتماعي**.
...
### 7. متابعة حساباتنا على شبكات التواصل الاجتماعي

1. **فتح التطبيق**: افتح التطبيق من متصفح الويب.
2. **الانتقال إلى قسم "تابعونا على شبكات التواصل الاجتماعي"**: قم بالتمرير إلى أسفل الصفحة الرئيسية.
3. **اختيار المنصة الاجتماعية**: سترى أيقونات المنصات الاجتماعية (فيسبوك، يوتيوب، تيليجرام، واتساب).
4. **النقر على الأيقونة المطلوبة**:
   - **فيسبوك**: سيتم توجيهك إلى صفحتنا على فيسبوك.
   - **يوتيوب**: سيتم توجيهك إلى قناتنا على يوتيوب.
   - **تيليجرام**: سيتم توجيهك إلى بوت تيليجرام الخاص بنا.
   - **واتساب**: سيتم توجيهك إلى مجموعة واتساب الخاصة بنا.
5. **التفاعل على المنصة**: يمكنك متابعة حساباتنا، التفاعل معنا، والبقاء على اطلاع بآخر التحديثات.
