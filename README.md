...
6. **الخيارات المتاحة للنص المعالج**:
   ...
   - اضغط على زر "**استماع**" للاستماع إلى النص باستخدام تقنية تحويل النص إلى كلام.
   - اضغط على زر "**إعادة الإنشاء**" لإعادة معالجة النص بنفس الإعدادات.
...
6. **الخيارات المتاحة للمحتوى**:
   - اضغط على زر "**نسخ المحتوى**" لنسخ المحتوى إلى الحافظة.
   - اضغط على زر "**استماع**" للاستماع إلى المحتوى باستخدام تقنية تحويل النص إلى كلام.
   - اضغط على زر "**إعادة الإنشاء**" لإعادة توليد المحتوى بنفس الإعدادات.
